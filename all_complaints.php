        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="text-center">
                    <?php if($row['status']==3){ ?>
                    <a href="view_complaint.php?id=<?php echo $row['id']; ?>"><button class="btn btn-primary">View Compalint</button></a>
                    <?php } else{  ?>
                    <button class="btn btn-danger" title="Not Allowed">Not Allowed</button>
                    <?php } ?>
                </td>
            </tr>
            <?php $i++; } } ?>
